ace.define('ace/mode/needs', ['require', 'exports', 'module' , 'ace/tokenizer', 'ace/mode/abap_highlight_rules', 'ace/mode/folding/coffee', 'ace/range', 'ace/mode/text', 'ace/lib/oop'], function(require, exports, module) {
...
var AbapHighlightRules = function() {
    ...
    var keyword = "\\b(Needs|Items|Requirements|Preferences)\\b";
    var def = "\\b(on|table|sum|max|min|Favorites|Dislikes|Lowest)\\b";
