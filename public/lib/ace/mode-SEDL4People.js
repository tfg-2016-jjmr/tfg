...
var AbapHighlightRules = function() {
    ...
    var keywordMapper = this.createKeywordMapper({
        ...
        "entity-name-tag.Configuration.1":
            "Outputs Inputs Setting Experimental_Setting Experimental_Procedure Procedure Runtimes Libraries Command Treatment role format mapping Result Runs" ,
    ...
    var configuration = "\\b(Outputs|Inputs|Setting|Experimental_Setting|Experimental_Procedure|Procedure|Runtimes|Libraries|Command|Treatment|role|format|mapping|Result|Runs)\\b";
    ...
    var comments = "(//.+)";
    var functions = "(\\b(linear|cuadratic|Random|Adhoc|Pvalue|Sthreshold|freedom_degrees|Mean|Mode|Avg|StdDev|Variance|Range|CI|IQR|Ranking|Pearson|ANOVA|Friedman|Tukey|KruskalWalls|TTest|Wilcoxon|Holms|FactANOVAwRS|File|Chi Square|Median" +
    ...
    var numerics = "(\\b(N|Z|Q|R|I|C|p-value)\\b)";
