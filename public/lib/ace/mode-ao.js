ace.define('ace/mode/ao', ['require', 'exports', 'module', 'ace/tokenizer', 'ace/mode/abap_highlight_rules', 'ace/mode/folding/coffee', 'ace/range', 'ace/mode/text', 'ace/lib/oop'], function (require, exports, module) {
...
ace.define('ace/mode/sintaxis_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (require, exports, module) {
    ...
    var AbapHighlightRules = function () {
        ...
        var keyword = "\\b(AgreementOffer|EndAgreementOffer|AgreementTerms|version)\\b";
        ...
        var atom2 = "(\\b(AND|OR|NOT)\\b)";
        var condition = "\\b(all|exactly|one|or|more)\\b";
        var roles = "\\b(Provider|Consumer)\\b";
        var attribute = "\\b(onlyIf|upon|[\w\$_]:)\\b";
        var type = "\\b(integer|string|enum|set|boolean|float|resource)\\b";
        var interval = "\\b(year|years|yearly|month|months|monthly|week|weeks|weekly|day|days|daily|hour|hours|hourly|minute|minutes|minutely|second|seconds)\\b";
        var compensation = "\\b(penalty|reward)\\b";
        var True = "\\b(true)\\b";
        var False = "\\b(false)\\b";
        var subtle = "\\b((|)|[|])\\b";
        ...
        this.$rules = {
            "start": [
                ...
                {token: "token_Keyword.roles", regex: roles},
                {token: "entity-name-tag.attribute", regex: attribute},
                {token: "entity-name-tag.type", regex: type},
                {token: "entity-name-tag.interval", regex: interval},
                {token: "entity-name-tag.compensation", regex: compensation},
