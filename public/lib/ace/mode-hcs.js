ace.define('ace/mode/hcs', ['require', 'exports', 'module' , 'ace/tokenizer', 'ace/mode/abap_highlight_rules', 'ace/mode/folding/coffee', 'ace/range', 'ace/mode/text', 'ace/lib/oop'], function(require, exports, module) {
...
var AbapHighlightRules = function() {
    ...
    var keyword = "\\b(Service|SelectableTerms|DerivedTerms|Dependencies|Highly_configurable|Services|GlobalTerms)\\b";
    var def = "\\b(table|sum|max|min|Favorites|Dislikes|Lowest)\\b";
    var type = "\\b(boolean|real|int|enum)\\b";
    var True = "\\b(true)\\b";
    var False = "\\b(false)\\b";
